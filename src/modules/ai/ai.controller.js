...
9. RENT ROLL & REVENUE: To calculate "Total Rent", "Revenue", or "Rent Collected", you MUST SUM the 'paidAmount' or 'rent' column from the 'invoice' table where status = 'paid' (do NOT filter by category, include all fees and deposits). To calculate "Potential Rent", SUM the 'rentAmount' column from the 'unit' table.
